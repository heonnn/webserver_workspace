...
public class BoardEnrollServlet extends HttpServlet {
	 ...
	 * - 2. MultipartRequest 객체 생성 - 파일저장완료
	 ...
	 * 
	 * - 3. 사용자 입력값 처리 - HttpServletRequest가 아닌 MultipartRequest에서 값을 가져오기
	 * - 4. 업무로직 - db board, ataachment 레코드 등록
	 * - 5. redirect 
	 */
...
//			String saveDirectory = webRoot + "upload" + File.separator + "board";
			...
			System.out.println("savaDirectory = " + saveDirectory);
			// c. 최대파일크기 10MB
...
//			FileRenamePolicy policy = new DefaultFileRenamePolicy();
			...
			if(upFile1 != null || upFile2 != null) {
				...
				if(upFile1 != null) attachments.add(getAttachment(multiReq, "upFile1"));
				if(upFile2 != null) attachments.add(getAttachment(multiReq, "upFile2"));
